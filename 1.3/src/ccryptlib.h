...
/* $Id: ccryptlib.h,v 1.2 2002/09/25 03:55:48 selinger Exp $ */
...
int ccdecrypt_init(ccrypt_stream_t *b, char *key);
...
/* The interface for encryption and decryption is the same. The
   ...
   or -2 on error with ccrypt_errno set.
*/
...
extern const char *ccrypt_errstr[];  /* cleartext error messages */
