...
static void xKeyAddition(word8 res[MAXBC][4], word8 a[MAXBC][4], 
...
static void xShiftRow(word8 res[MAXBC][4], word8 a[MAXBC][4], int shift[4], 
	       word8 BC)
{
...
static void xSubstitution(word8 a[MAXBC][4], word8 box[256], word8 BC) {
...
static void xShiftSubst(word8 res[MAXBC][4], word8 a[MAXBC][4], int shift[4], 
...
static void xMixColumn(word8 res[MAXBC][4], word8 a[MAXBC][4], word8 BC) {
  int j;
  word32 b;
...
static void xMixAdd(word8 res[MAXBC][4], word8 a[MAXBC][4], word32 rk[MAXBC], 
	     word8 BC) {
  int j;
  word32 b;
...
/* the result is written to res, which may equal a */
static void xInvMixColumn(word8 res[MAXBC][4], word8 a[MAXBC][4], word8 BC) {
  int j;
  word32 b;
...
static void xAddInvMix(word8 res[MAXBC][4], word8 a[MAXBC][4], word32 rk[MAXBC], 
		  word8 BC) {
  int j;
  word32 b;
